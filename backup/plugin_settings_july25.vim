...
if filereadable(expand('~/.vim/plugged/vim-indent-guides'))
...
if filereadable(expand("~/.vim/plugged/vim-jsx/after/ftplugin/jsx.vim"))
...
if filereadable(expand("~/.vim/plugged/vim-leader-guide/plugin/leaderGuide.vim"))
    let g:lmap        = {}
